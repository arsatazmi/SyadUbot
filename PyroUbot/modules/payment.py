...
async def _(client, callback_query):
    ...
    try:
        ...
        pesan = await bot.ask(
            user_id,
            f"""
<blockquote><b>SILAHKAN MELAKUKAN PEMBAYARAN DENGAN LEWAT PAYMENT QRIS OWNER</b>           

QRIS : https://files.catbox.moe/p1piff.jpg
...
""",
            ...
            CONFIRM_PAYMENT.remove(get.id)
            buttons = [
                [InlineKeyboardButton("📞 ᴏᴡɴᴇʀ", url="https://t.me/SyadTech")]
            ]
            return await bot.send_message(
                user_id,
                f"""
